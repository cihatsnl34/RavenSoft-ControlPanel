                            ...
                            <div class="card-body">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$rs->adress}}</td>   
                                        <td>
                                            <a class="inline-block mr-2" href="{{route('admin.admin_Apartner_approve',['id' =>$rs->id])}}"onclick="return confirm('Approve ! Are you sure ?')">
                                            ...
                                            <a class="inline-block" href="{{route('admin.admin_Apartner_delete',['id' =>$rs->id])}}" onclick="return confirm('Delete ! Are you sure ?')">
