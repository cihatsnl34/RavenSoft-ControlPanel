                            ...
                            <div class="card-body">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$rs->price}}</td>     
                                        <td>
                                            <a class="inline-block mr-2" href="{{route('admin.admin_packets_edit',['id' =>$rs->id])}}">
                                            ...
                                            <a class="inline-block" href="{{route('admin.admin_packets_delete',['id' =>$rs->id])}}" onclick="return confirm('Delete ! Are you sure ?')">
