                            ...
                            <div class="card-body">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; width: 100%;">
                                    ...
                                    <tr>
                                        <td>{{$rs->title}}</td>
                                        <td>{{$rs->property}}</td>
                                        <td>{{$rs->packetDuration." Ay"}}</td>
                                        <td>{{$rs->licenseKey}}</td>
                                        <td>{{$rs->price}}</td>     
                                        <td>
                                            <a class="inline-block mr-2" href="{{route('company.company_packets_edit',['id' =>$rs->id])}}">
                                            ...
                                            <a class="inline-block" href="{{route('company.company_packets_delete',['id' =>$rs->id])}}" onclick="return confirm('Delete ! Are you sure ?')">
