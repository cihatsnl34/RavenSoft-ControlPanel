...
@section('content')
        ...
        <div class="">
            <div class="page-header-title">
                <h4 class="page-title">Active Service List</h4>
            </div>
        </div>
                            ...
                            <div class="card-body">
                                ...
                                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; width: 100%;">
                                    ...
                                    <tr>
                                        ...
                                        <td>{{$rs->created_at}}</td>   
                                        <td>
                                            <a class="inline-block mr-2" href="{{route('company.activeService_edit',['id' =>$rs->id])}}"onclick="return confirm('Edit ! Are you sure ?')">
                                            ...
                                            <a class="inline-block" href="{{route('company.activeService_delete',['id' =>$rs->id])}}" onclick="return confirm('Delete ! Are you sure ?')">
